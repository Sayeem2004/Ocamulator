...
let bcc_op (type a') (mode : a' Decode.memory_mode) (cpu : Cpu.t) : Cpu.t =
    if not cpu.flags.carry then { cpu with progCounter = Decode.address cpu mode }
    else cpu
...
let bmi_op (type a') (mode : a' Decode.memory_mode) (cpu : Cpu.t) : Cpu.t =
    if cpu.flags.negative then { cpu with progCounter = Decode.address cpu mode }
    else cpu

let bne_op (type a') (mode : a' Decode.memory_mode) (cpu : Cpu.t) : Cpu.t =
    if not cpu.flags.zero then { cpu with progCounter = Decode.address cpu mode }
    else cpu
...
let bvs_op (type a') (mode : a' Decode.memory_mode) (cpu : Cpu.t) : Cpu.t =
    if cpu.flags.overflow then { cpu with progCounter = Decode.address cpu mode }
    else cpu
