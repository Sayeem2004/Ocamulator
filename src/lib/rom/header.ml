...
(* For documentation on all of these flags and what they mean,
...
(* Got lazy and didn't want to write specifications for other flags,
   see website at top for details *)
...
let flags_6_ver (header_buffer : Bytes.t) =
  ...
  {
    mirroring = nth_bit_ui8 flags_6_ui8 0;
    persistent_mem =  nth_bit_ui8 flags_6_ui8 1;
    trainer_present = nth_bit_ui8 flags_6_ui8 2;
    ignore_mirroring_control = nth_bit_ui8 flags_6_ui8 3;
...
let flags_7_ver (header_buffer : Bytes.t) =
  ...
  {
    vs_unisystem = nth_bit_ui8 flags_7_ui8 0;
    playchoice = nth_bit_ui8 flags_7_ui8 1;
    nes_2 = (nth_bit_ui8 flags_7_ui8 3) && not (nth_bit_ui8 flags_7_ui8 2);
...
let flags_9_ver (header_buffer : Bytes.t) =
  ...
  let tv_system_bit = nth_bit_ui8 flags_9_ui8 0 in
...
let flags_10_ver (header_buffer : Bytes.t) =
  ...
  let tv_system = match nth_bit_ui8 flags_10_ui8 1, nth_bit_ui8 flags_10_ui8 0 with
  | false, false -> NTSC
  | true, false -> PAL
  | _ -> DUAL in
  {
    tv_system;
    prg_ram_present = nth_bit_ui8 flags_10_ui8 0x4;
    bus_conflicts = nth_bit_ui8 flags_10_ui8 0x5;
  }
