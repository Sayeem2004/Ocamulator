...
let ui16_combine_ui8_tests : test list =
    [
        combine_ui8_test "UI16_Combine_UI8 Zero Zero -> $0000" UInt8.zero UInt8.zero
            UInt16.zero;
        combine_ui8_test "UI16_Combine_UI8 Zero Ones -> $0001" UInt8.zero UInt8.one
            UInt16.one;
        combine_ui8_test "UI16_Combine_UI8 Ones Zero -> $0100" UInt8.one UInt8.zero
            (UInt16.from_int 0x0100);
        combine_ui8_test "UI16_Combine_UI8 Ones Ones -> $0101" UInt8.one UInt8.one
            (UInt16.from_int 0x0101);
